...
//#region src/pages/api/checkout/[...path].ts
var ____path__exports = /* @__PURE__ */ __exportAll({ ALL: () => ALL });
var ALL = async ({ params, request }) => {
	const pathSuffix = params.path ? `/${params.path}` : "";
	const targetUrl = `${"http://138.2.172.187/graphql".replace(/\/graphql$/, "")}/wp-json/wc/store/v1/checkout${pathSuffix}`;
	...
	try {
		...
		if (remoteNonce) console.log(`[CheckoutProxy] Captured Nonce from WP: ${remoteNonce}`);
...
//#endregion
//#region \0virtual:astro:page:src/pages/api/checkout/[...path]@_@ts
